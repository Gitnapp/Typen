...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  Widget _buildRichText(TextSpan text, {TextAlign? textAlign, String? key}) {
    ...
    if (selectable) {
      ...
      // LineHeightText instead of Text.rich: stock text under a SelectionArea
      // paints glyph-tight selection boxes with hard-coded BoxHeightStyle.tight;
      // ours cover the full line height so selected lines tile into a flat block.
      return LineHeightText(
        text,
        textScaler: styleSheet.textScaler,
        textAlign: textAlign ?? TextAlign.start,
        strutStyle: strutStyle,
